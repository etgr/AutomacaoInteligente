...
figure;
plot(t,gam,t,gamA,t,gamB,t,gamC);
xlabel('Tempo (s)');
ylabel('\Gamma (cm)');
legend('Real', 'Algoritmo A', 'Algoritmo B', 'Algoritmo C');
figure;
plot(t,rad2deg(tet),t,rad2deg(tetA),t,rad2deg(tetB),t,rad2deg(tetC));
xlabel('Tempo (s)');
ylabel('\Theta (º)');
title('\Theta');
legend('Real', 'Algoritmo A', 'Algoritmo B', 'Algoritmo C');
